...
Shader "DBK URP/BrickRubbleTile"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 texCoord218 = v.texcoord.xy * temp_cast_0 + float2( 0,0 );
						 ...
						 ) : SV_Target
			{
				...
				float2 temp_cast_0 = (_MainTiling).xx;
				float2 texCoord218 = IN.ase_texcoord8.xy * temp_cast_0 + float2( 0,0 );
				float2 Tiling220 = texCoord218;
				...
				float2 texCoord80 = IN.ase_texcoord8.zw * _ColorsNumber + appendResult79;
				...
				float2 texCoord89 = IN.ase_texcoord8.xy * temp_cast_5 + float2( 0,0 );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v )
			{
				...
				float2 temp_cast_0 = (_MainTiling).xx;
				float2 texCoord218 = v.ase_texcoord.xy * temp_cast_0 + float2( 0,0 );
				float2 Tiling220 = texCoord218;
				float4 tex2DNode133 = tex2Dlod( _MainTex1, float4( Tiling220, 0, 0.0) );
				float Mask_A_Alpha136 = tex2DNode133.a;
				float VertexBlue194 = v.ase_color.b;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 temp_cast_0 = (_MainTiling).xx;
				float2 texCoord218 = v.texcoord0.xy * temp_cast_0 + float2( 0,0 );
				float2 Tiling220 = texCoord218;
				float4 tex2DNode133 = tex2Dlod( _MainTex1, float4( Tiling220, 0, 0.0) );
				float Mask_A_Alpha136 = tex2DNode133.a;
				float VertexBlue194 = v.ase_color.b;
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 temp_cast_0 = (_MainTiling).xx;
				float2 texCoord218 = IN.ase_texcoord4.xy * temp_cast_0 + float2( 0,0 );
				float2 Tiling220 = texCoord218;
				float4 tex2DNode133 = tex2D( _MainTex1, Tiling220 );
				float Mask_A_Red134 = tex2DNode133.r;
				float4 temp_cast_1 = (Mask_A_Red134).xxxx;
				...
				float2 temp_output_74_0 = ( half2( 0.015625,0 ) * staticSwitch72 );
				float2 appendResult79 = (float2(temp_output_74_0.x , -0.86));
				float2 texCoord80 = IN.ase_texcoord4.zw * _ColorsNumber + appendResult79;
				float4 Color383 = tex2D( _MainTex, texCoord80 );
				float2 texCoord77 = IN.ase_texcoord4.zw * _ColorsNumber + temp_output_74_0;
				float4 Color1UV381 = tex2D( _MainTex, texCoord77 );
				float2 temp_cast_5 = (_DetailsTiling).xx;
				float2 texCoord89 = IN.ase_texcoord4.xy * temp_cast_5 + float2( 0,0 );
				float4 tex2DNode55 = tex2D( _MaskB, texCoord89 );
				float Mask_B_Red56 = tex2DNode55.r;
				float3 temp_cast_6 = (( 1.0 - Mask_B_Red56 )).xxx;
				float Mask_B_Green57 = tex2DNode55.g;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 temp_cast_0 = (_MainTiling).xx;
				float2 texCoord218 = IN.ase_texcoord2.xy * temp_cast_0 + float2( 0,0 );
				float2 Tiling220 = texCoord218;
				float4 tex2DNode133 = tex2D( _MainTex1, Tiling220 );
				float Mask_A_Red134 = tex2DNode133.r;
				float4 temp_cast_1 = (Mask_A_Red134).xxxx;
				...
				float2 temp_output_74_0 = ( half2( 0.015625,0 ) * staticSwitch72 );
				float2 appendResult79 = (float2(temp_output_74_0.x , -0.86));
				float2 texCoord80 = IN.ase_texcoord2.zw * _ColorsNumber + appendResult79;
				float4 Color383 = tex2D( _MainTex, texCoord80 );
				float2 texCoord77 = IN.ase_texcoord2.zw * _ColorsNumber + temp_output_74_0;
				float4 Color1UV381 = tex2D( _MainTex, texCoord77 );
				float2 temp_cast_5 = (_DetailsTiling).xx;
				float2 texCoord89 = IN.ase_texcoord2.xy * temp_cast_5 + float2( 0,0 );
				float4 tex2DNode55 = tex2D( _MaskB, texCoord89 );
				float Mask_B_Red56 = tex2DNode55.r;
				float3 temp_cast_6 = (( 1.0 - Mask_B_Red56 )).xxx;
				float Mask_B_Green57 = tex2DNode55.g;
...
/*ASEBEGIN
Version=18935
2560;133;1920;1133;-1664.295;416.0233;1;True;False
...
Node;AmplifyShaderEditor.GetLocalVarNode;209;2467.544,473.0228;Inherit;False;208;AlphaMap;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;206;2481.644,698.8221;Inherit;False;205;Tessalation;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;242;2391.039,568.4606;Inherit;False;Property;_AlphaClip;Alpha Clip;23;0;Create;True;0;0;0;False;0;False;0.1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;248;2653.356,236.0344;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;117;-372.9296,1576.103;Inherit;False;Color Mask;-1;;46;eec747d987850564c95bde0e5a6d1867;0;4;1;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0.17;False;5;FLOAT;0.37;False;1;FLOAT;0
...
WireConnection;237;1;95;0
WireConnection;237;4;164;0
WireConnection;237;6;209;0
WireConnection;237;7;242;0
WireConnection;237;8;206;0
ASEEND*/
//CHKSM=29F25E66E5B054C150FCB0F031073D1E5A41CC09