...
Shader "DBK URP/CinderblockRubbleTile"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 uv_MainTex1 = v.texcoord.xy * _MainTex1_ST.xy + _MainTex1_ST.zw;
				...
				float2 texCoord89 = v.texcoord.xy * temp_cast_1 + float2( 0,0 );
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord80 = IN.ase_texcoord8.xy * _ColorsNumber + appendResult79;
				float4 Color383 = tex2D( _MainTex, texCoord80 );
				float2 uv_MainTex1 = IN.ase_texcoord8.zw * _MainTex1_ST.xy + _MainTex1_ST.zw;
				float4 tex2DNode133 = tex2D( _MainTex1, uv_MainTex1 );
				float Mask_A_Red134 = tex2DNode133.r;
				float2 texCoord77 = IN.ase_texcoord8.xy * _ColorsNumber + temp_output_74_0;
				float4 Color1UV381 = tex2D( _MainTex, texCoord77 );
				float2 temp_cast_3 = (_DetailsTiling).xx;
				float2 texCoord89 = IN.ase_texcoord8.zw * temp_cast_3 + float2( 0,0 );
				...
				float2 texCoord85 = IN.ase_texcoord8.xy * _ColorsNumber + appendResult87;
				...
				float2 uv_BrickTileNM = IN.ase_texcoord8.zw * _BrickTileNM_ST.xy + _BrickTileNM_ST.zw;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v )
			{
				...
				float3 temp_cast_0 = (VertexBlue194).xxx;
				float2 temp_cast_1 = (_DetailsTiling).xx;
				float2 texCoord89 = v.ase_texcoord.xy * temp_cast_1 + float2( 0,0 );
				float4 tex2DNode55 = tex2Dlod( _MaskB, float4( texCoord89, 0, 0.0) );
				float Mask_B_Red56 = tex2DNode55.r;
				float3 temp_cast_2 = (( 1.0 - Mask_B_Red56 )).xxx;
				float clampResult188 = clamp( saturate( ( 1.0 - ( ( distance( temp_cast_0 , temp_cast_2 ) - _CutAlphaRange ) / max( _CutAlphaSmooth , 1E-05 ) ) ) ) , 0.0 , 1.0 );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 uv_MainTex1 = v.texcoord0.xy * _MainTex1_ST.xy + _MainTex1_ST.zw;
				float4 tex2DNode133 = tex2Dlod( _MainTex1, float4( uv_MainTex1, 0, 0.0) );
				float Mask_A_Alpha136 = tex2DNode133.a;
				float VertexBlue194 = v.ase_color.b;
				float3 temp_cast_0 = (VertexBlue194).xxx;
				float2 temp_cast_1 = (_DetailsTiling).xx;
				float2 texCoord89 = v.texcoord0.xy * temp_cast_1 + float2( 0,0 );
				float4 tex2DNode55 = tex2Dlod( _MaskB, float4( texCoord89, 0, 0.0) );
				float Mask_B_Red56 = tex2DNode55.r;
				float3 temp_cast_2 = (( 1.0 - Mask_B_Red56 )).xxx;
				float clampResult188 = clamp( saturate( ( 1.0 - ( ( distance( temp_cast_0 , temp_cast_2 ) - _CutAlphaRange ) / max( _CutAlphaSmooth , 1E-05 ) ) ) ) , 0.0 , 1.0 );
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 temp_output_74_0 = ( half2( 0.015625,0 ) * staticSwitch72 );
				float2 appendResult79 = (float2(temp_output_74_0.x , 0.1));
				float2 texCoord80 = IN.ase_texcoord4.xy * _ColorsNumber + appendResult79;
				float4 Color383 = tex2D( _MainTex, texCoord80 );
				float2 uv_MainTex1 = IN.ase_texcoord4.zw * _MainTex1_ST.xy + _MainTex1_ST.zw;
				float4 tex2DNode133 = tex2D( _MainTex1, uv_MainTex1 );
				float Mask_A_Red134 = tex2DNode133.r;
				float2 texCoord77 = IN.ase_texcoord4.xy * _ColorsNumber + temp_output_74_0;
				float4 Color1UV381 = tex2D( _MainTex, texCoord77 );
				float2 temp_cast_3 = (_DetailsTiling).xx;
				float2 texCoord89 = IN.ase_texcoord4.zw * temp_cast_3 + float2( 0,0 );
				float4 tex2DNode55 = tex2D( _MaskB, texCoord89 );
				float Mask_B_Red56 = tex2DNode55.r;
				float3 temp_cast_4 = (( 1.0 - Mask_B_Red56 )).xxx;
				float Mask_B_Green57 = tex2DNode55.g;
				...
				float4 lerpResult126 = lerp( ( Color383 * Mask_A_Red134 ) , Color1UV381 , PaintSelection119);
				float2 appendResult87 = (float2(temp_output_74_0.x , 0.5));
				float2 texCoord85 = IN.ase_texcoord4.xy * _ColorsNumber + appendResult87;
				float4 Color2UV386 = tex2D( _MainTex, texCoord85 );
				float Mask_B_Alpha59 = tex2DNode55.a;
				float VertexRed62 = IN.ase_color.r;
				float3 temp_cast_7 = (( VertexRed62 * Mask_B_Alpha59 )).xxx;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 temp_output_74_0 = ( half2( 0.015625,0 ) * staticSwitch72 );
				float2 appendResult79 = (float2(temp_output_74_0.x , 0.1));
				float2 texCoord80 = IN.ase_texcoord2.xy * _ColorsNumber + appendResult79;
				float4 Color383 = tex2D( _MainTex, texCoord80 );
				float2 uv_MainTex1 = IN.ase_texcoord2.zw * _MainTex1_ST.xy + _MainTex1_ST.zw;
				float4 tex2DNode133 = tex2D( _MainTex1, uv_MainTex1 );
				float Mask_A_Red134 = tex2DNode133.r;
				float2 texCoord77 = IN.ase_texcoord2.xy * _ColorsNumber + temp_output_74_0;
				float4 Color1UV381 = tex2D( _MainTex, texCoord77 );
				float2 temp_cast_3 = (_DetailsTiling).xx;
				float2 texCoord89 = IN.ase_texcoord2.zw * temp_cast_3 + float2( 0,0 );
				float4 tex2DNode55 = tex2D( _MaskB, texCoord89 );
				float Mask_B_Red56 = tex2DNode55.r;
				float3 temp_cast_4 = (( 1.0 - Mask_B_Red56 )).xxx;
				float Mask_B_Green57 = tex2DNode55.g;
				...
				float4 lerpResult126 = lerp( ( Color383 * Mask_A_Red134 ) , Color1UV381 , PaintSelection119);
				float2 appendResult87 = (float2(temp_output_74_0.x , 0.5));
				float2 texCoord85 = IN.ase_texcoord2.xy * _ColorsNumber + appendResult87;
				float4 Color2UV386 = tex2D( _MainTex, texCoord85 );
				float Mask_B_Alpha59 = tex2DNode55.a;
				float VertexRed62 = IN.ase_color.r;
				float3 temp_cast_7 = (( VertexRed62 * Mask_B_Alpha59 )).xxx;
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 uv_BrickTileNM = IN.ase_texcoord4.xy * _BrickTileNM_ST.xy + _BrickTileNM_ST.zw;
				float3 unpack217 = UnpackNormalScale( tex2D( _BrickTileNM, uv_BrickTileNM ), _BrickNMScale );
				unpack217.z = lerp( 1, unpack217.z, saturate(_BrickNMScale) );
				float2 temp_cast_0 = (_DetailsTiling).xx;
				float2 texCoord89 = IN.ase_texcoord4.xy * temp_cast_0 + float2( 0,0 );
				float2 TilingAmount91 = texCoord89;
				float3 unpack21 = UnpackNormalScale( tex2D( _DetailsNM, TilingAmount91 ), _DetailsNMScale );
				unpack21.z = lerp( 1, unpack21.z, saturate(_DetailsNMScale) );
				float3 Normals94 = BlendNormal( unpack217 , unpack21 );
				...
				float Mask_B_Red56 = tex2DNode55.r;
				float3 temp_cast_2 = (( 1.0 - Mask_B_Red56 )).xxx;
				float clampResult188 = clamp( saturate( ( 1.0 - ( ( distance( temp_cast_1 , temp_cast_2 ) - _CutAlphaRange ) / max( _CutAlphaSmooth , 1E-05 ) ) ) ) , 0.0 , 1.0 );
				float AlphaSelection189 = clampResult188;
				float temp_output_202_0 = ( 1.0 - AlphaSelection189 );
				float AlphaMap208 = temp_output_202_0;
...
/*ASEBEGIN
Version=18935
2560;133;1920;1133;-2512.239;436.3945;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;185;1263.857,2380.128;Inherit;False;Color Mask;-1;;52;eec747d987850564c95bde0e5a6d1867;0;4;1;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0.17;False;5;FLOAT;0.37;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;171;1075.518,1906.409;Float;False;Property;_Displacement;Displacement;0;0;Create;True;0;0;0;False;0;False;0.2;0.177;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;48;2693.391,1471.694;Inherit;False;Color Mask;-1;;53;eec747d987850564c95bde0e5a6d1867;0;4;1;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0.17;False;5;FLOAT;0.37;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;243;2443.065,-131.5213;Inherit;False;Property;_Color;Color;23;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;117;-372.9296,1576.103;Inherit;False;Color Mask;-1;;54;eec747d987850564c95bde0e5a6d1867;0;4;1;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0.17;False;5;FLOAT;0.37;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;244;2630.189,214.5942;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;144;2454.374,197.4877;Inherit;False;143;Albedo;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;215;-2469.783,1550.812;Inherit;False;Property;_BrickNMScale;Brick NM Scale;20;0;Create;True;0;0;0;False;0;False;1;1;1;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;95;2469.592,297.6969;Inherit;False;94;Normals;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SamplerNode;217;-2152.783,1484.812;Inherit;True;Property;_BrickTileNM;Brick Tile NM;19;0;Create;True;0;0;0;False;0;False;-1;dc820580967230744910ba914b8a57f2;dc820580967230744910ba914b8a57f2;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;234;1;95;0
WireConnection;234;4;164;0
WireConnection;234;6;209;0
WireConnection;234;7;231;0
WireConnection;234;8;206;0
ASEEND*/
//CHKSM=FD300DCC2C6B0FFA805E9635DC5B56EEBB123BAB