	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord18 = IN.ase_texcoord8.xy * temp_cast_0 + float2( 0,0 );
				...
				float2 texCoord98 = IN.ase_texcoord8.xy * _ColorsNumber + temp_output_96_0;
				...
				float2 texCoord107 = IN.ase_texcoord8.xy * _ColorsNumber + appendResult103;
				...
				float2 uv_MainNM = IN.ase_texcoord8.xy * _MainNM_ST.xy + _MainNM_ST.zw;
				...
				float2 texCoord11 = IN.ase_texcoord8.xy * temp_cast_11 + float2( 0,0 );
				...
				float3 Albedo = ( Albedo223 * _Color ).rgb;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 tex2DNode250 = tex2D( _ColorMap, uv_ColorMap );
				float2 temp_cast_0 = (_DetailNMTiling).xx;
				float2 texCoord18 = IN.ase_texcoord4.xy * temp_cast_0 + float2( 0,0 );
				float2 ConcreteUVTiling73 = texCoord18;
				float4 tex2DNode85 = tex2D( _MaskB, ConcreteUVTiling73 );
				float Mask_B_Alpha89 = tex2DNode85.a;
				...
				#endif
				float2 temp_output_96_0 = ( half2( 0.015625,0 ) * staticSwitch94 );
				float2 texCoord98 = IN.ase_texcoord4.xy * _ColorsNumber + temp_output_96_0;
				float4 Color1UV3105 = tex2D( _MainTex1, texCoord98 );
				float Mask_B_Blue88 = tex2DNode85.b;
				float Mask_B_Red86 = tex2DNode85.r;
				float3 temp_cast_5 = (( 1.0 - Mask_B_Red86 )).xxx;
				...
				float4 lerpResult37 = lerp( float4( desaturateVar247 , 0.0 ) , ( Color1UV3105 + ( Mask_B_Blue88 * Color1UV3105 ) ) , PaintSelection123);
				float2 appendResult103 = (float2(temp_output_96_0.x , 0.1));
				float2 texCoord107 = IN.ase_texcoord4.xy * _ColorsNumber + appendResult103;
				float4 DirtColorUV3109 = tex2D( _MainTex1, texCoord107 );
				float VertexRed125 = IN.ase_color.r;
				float3 temp_cast_8 = (( VertexRed125 * Mask_B_Alpha89 )).xxx;
				float3 temp_cast_9 = (( ( 1.0 - Mask_B_Red86 ) + ( ( 1.0 - MaskARed84 ) * _DirtInsideMultiplier ) )).xxx;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				#endif
				float2 temp_output_96_0 = ( half2( 0.015625,0 ) * staticSwitch94 );
				float2 texCoord98 = IN.ase_texcoord2.xy * _ColorsNumber + temp_output_96_0;
				float4 Color1UV3105 = tex2D( _MainTex1, texCoord98 );
				float Mask_B_Blue88 = tex2DNode85.b;
				float Mask_B_Red86 = tex2DNode85.r;
				float3 temp_cast_5 = (( 1.0 - Mask_B_Red86 )).xxx;
				...
				float4 lerpResult37 = lerp( float4( desaturateVar247 , 0.0 ) , ( Color1UV3105 + ( Mask_B_Blue88 * Color1UV3105 ) ) , PaintSelection123);
				float2 appendResult103 = (float2(temp_output_96_0.x , 0.1));
				float2 texCoord107 = IN.ase_texcoord2.xy * _ColorsNumber + appendResult103;
				float4 DirtColorUV3109 = tex2D( _MainTex1, texCoord107 );
				float VertexRed125 = IN.ase_color.r;
				float3 temp_cast_8 = (( VertexRed125 * Mask_B_Alpha89 )).xxx;
				float3 temp_cast_9 = (( ( 1.0 - Mask_B_Red86 ) + ( ( 1.0 - MaskARed84 ) * _DirtInsideMultiplier ) )).xxx;
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 uv_MainNM = IN.ase_texcoord4.xy * _MainNM_ST.xy + _MainNM_ST.zw;
				float3 tex2DNode2 = UnpackNormalScale( tex2D( _MainNM, uv_MainNM ), 1.0f );
				float2 temp_cast_0 = (_DetailNMTiling).xx;
				float2 texCoord18 = IN.ase_texcoord4.xy * temp_cast_0 + float2( 0,0 );
				float3 unpack15 = UnpackNormalScale( tex2D( _DetailNM, texCoord18 ), _DetailScale );
				...
				float2 texCoord11 = IN.ase_texcoord4.xy * temp_cast_1 + float2( 0,0 );
				float3 unpack3 = UnpackNormalScale( tex2D( _DamageNM, texCoord11 ), _DamageScale );
				unpack3.z = lerp( 1, unpack3.z, saturate(_DamageScale) );
				float2 uv_MainTex = IN.ase_texcoord4.xy * _MainTex_ST.xy + _MainTex_ST.zw;
				float4 tex2DNode75 = tex2D( _MainTex, uv_MainTex );
...
/*ASEBEGIN
Version=18935
2560;133;1920;1133;-3342.819;16.60837;1;True;False
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;285;4483.881,530.4493;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.IntNode;93;-2897.202,-1103.97;Inherit;False;Property;_ColorSelect;ColorSelect;3;1;[PerRendererData];Create;True;0;0;0;False;0;False;0;0;False;0;1;INT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;224;4285.458,566.1423;Inherit;False;223;Albedo;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;29;-2354.354,1324.576;Inherit;False;Color Mask;-1;;44;eec747d987850564c95bde0e5a6d1867;0;4;1;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0.17;False;5;FLOAT;0.37;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;39;-675.8323,1669.753;Inherit;False;Color Mask;-1;;43;eec747d987850564c95bde0e5a6d1867;0;4;1;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0.17;False;5;FLOAT;0.37;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;284;4051.757,163.3338;Inherit;False;Property;_Color;Color;27;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
