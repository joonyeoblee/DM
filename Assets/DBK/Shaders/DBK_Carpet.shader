	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord158 = IN.ase_texcoord8.xy * _ColorsNumber + temp_output_154_0;
				...
				float2 texCoord157 = IN.ase_texcoord8.xy * _ColorsNumber + appendResult155;
				...
				float4 lerpResult47 = lerp( ( ( PrimaryColor146 * tex2DNode115.r ) * ( IN.ase_color.g + _Brightness ) * _Darkness ) , ( UndersideColorUV3145 * tex2DNode115.a ) , float4( ( ( ( 1.0 - IN.ase_color.b ) * CutoutEdges44 ) + IN.ase_color.b ) , 0.0 ));
				...
				float2 texCoord163 = IN.ase_texcoord8.xy * _ColorsNumber + appendResult161;
				...
				float VertexRed124 = IN.ase_color.r;
				...
				float4 lerpResult31 = lerp( lerpResult47 , ( ( CarpetMaskAlpha108 * DirtColorUV3147 ) * IN.ase_color.g * ( CarpetMaskBlue106 + tex2DNode115.a ) ) , ( DirtHeight17 * _DirtOpacity ));
				float4 Albedo99 = lerpResult31;
				
				clip( tex2DNode115.a - ( IN.ase_color.g * _Threshold ));
				float OpactiyMask103 = ( 1.0 * tex2DNode39.b );
				
				float3 Albedo = ( Albedo99 * _Color ).rgb;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				#endif
				float2 temp_output_154_0 = ( half2( 0.015625,0 ) * staticSwitch168 );
				float2 texCoord158 = IN.ase_texcoord4.xy * _ColorsNumber + temp_output_154_0;
				float4 PrimaryColor146 = tex2D( _MainTex, texCoord158 );
				float2 uv_RGBAMaskA = IN.ase_texcoord4.xy * _RGBAMaskA_ST.xy + _RGBAMaskA_ST.zw;
				float4 tex2DNode115 = tex2D( _RGBAMaskA, uv_RGBAMaskA );
				float2 appendResult155 = (float2(temp_output_154_0.x , 0.5));
				float2 texCoord157 = IN.ase_texcoord4.xy * _ColorsNumber + appendResult155;
				float4 UndersideColorUV3145 = tex2D( _MainTex, texCoord157 );
				...
				float CarpetMaskAlpha108 = tex2DNode102.a;
				float2 appendResult161 = (float2(temp_output_154_0.x , 0.1));
				float2 texCoord163 = IN.ase_texcoord4.xy * _ColorsNumber + appendResult161;
				float4 DirtColorUV3147 = tex2D( _MainTex, texCoord163 );
				float CarpetMaskBlue106 = tex2DNode102.b;
				float3 temp_cast_6 = (( tex2DNode102.g * _DirtMultiplier )).xxx;
				float VertexRed124 = IN.ase_color.r;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				#endif
				float2 temp_output_154_0 = ( half2( 0.015625,0 ) * staticSwitch168 );
				float2 texCoord158 = IN.ase_texcoord2.xy * _ColorsNumber + temp_output_154_0;
				float4 PrimaryColor146 = tex2D( _MainTex, texCoord158 );
				float2 uv_RGBAMaskA = IN.ase_texcoord2.xy * _RGBAMaskA_ST.xy + _RGBAMaskA_ST.zw;
				float4 tex2DNode115 = tex2D( _RGBAMaskA, uv_RGBAMaskA );
				float2 appendResult155 = (float2(temp_output_154_0.x , 0.5));
				float2 texCoord157 = IN.ase_texcoord2.xy * _ColorsNumber + appendResult155;
				float4 UndersideColorUV3145 = tex2D( _MainTex, texCoord157 );
				float2 uv4_RGBAMaskA = IN.ase_texcoord2.zw * _RGBAMaskA_ST.xy + _RGBAMaskA_ST.zw;
				float4 tex2DNode39 = tex2D( _RGBAMaskA, uv4_RGBAMaskA );
				float3 temp_cast_3 = (pow( ( 1.0 - tex2DNode39.b ) , _Edges )).xxx;
				...
				float CarpetMaskAlpha108 = tex2DNode102.a;
				float2 appendResult161 = (float2(temp_output_154_0.x , 0.1));
				float2 texCoord163 = IN.ase_texcoord2.xy * _ColorsNumber + appendResult161;
				float4 DirtColorUV3147 = tex2D( _MainTex, texCoord163 );
				float CarpetMaskBlue106 = tex2DNode102.b;
				float3 temp_cast_6 = (( tex2DNode102.g * _DirtMultiplier )).xxx;
				float VertexRed124 = IN.ase_color.r;
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 uv_RGBAMaskA = IN.ase_texcoord.xy * _RGBAMaskA_ST.xy + _RGBAMaskA_ST.zw;
				float4 tex2DNode115 = tex2D( _RGBAMaskA, uv_RGBAMaskA );
				clip( tex2DNode115.a - ( IN.ase_color.g * _Threshold ));
				float2 uv4_RGBAMaskA = IN.ase_texcoord.zw * _RGBAMaskA_ST.xy + _RGBAMaskA_ST.zw;
				float4 tex2DNode39 = tex2D( _RGBAMaskA, uv4_RGBAMaskA );
				float OpactiyMask103 = ( 1.0 * tex2DNode39.b );
...
/*ASEBEGIN
Version=18935
2560;133;1920;1133;-1810.548;1381.937;1;True;False
...
Node;AmplifyShaderEditor.GetLocalVarNode;100;2586.395,-794.1005;Inherit;False;99;Albedo;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;181;2750.828,-643.9863;Inherit;False;Constant;_Metallic;Metallic;15;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;193;2576.171,-1230.576;Inherit;False;Property;_Color;Color;15;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;194;2841.295,-797.4601;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
WireConnection;184;4;181;0
WireConnection;184;6;104;0
WireConnection;184;7;180;0
ASEEND*/
//CHKSM=1A6681B334A2AA70B76CF13EAEA8C2652167CAF8